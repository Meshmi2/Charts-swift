...
public class PieChartView: PieRadarChartViewBase {
    ...
    public var holeColor: Color? = .white {
        didSet{
            setNeedsDisplay()
        }
    }
    ...
    /// **default**: `false`
    public var isDrawSlicesUnderHoleEnabled = false {
        didSet {
            setNeedsDisplay()
        }
    }
    ...
    public var isDrawHoleEnabled = true {
        didSet {
            setNeedsDisplay()
        }
    }
    ...
    public var isDrawCenterTextEnabled = true {
        didSet {
            setNeedsDisplay()
        }
    }
    ...
    ///
    /// **default**: `nil`
    public var transparentCircleColor: Color? {
        get {
    ...
    public var entryLabelColor: Color? = .white {
        didSet {
            setNeedsDisplay()
        }
    }
    ...
    public var entryLabelFont: Font? = Font(name: "HelveticaNeue", size: 13.0) {
       didSet {
            setNeedsDisplay()
        }
    }
    ...
    public var isDrawEntryLabelsEnabled = true {
        didSet {
            setNeedsDisplay()
        }
    }
    ...
    public var usePercentValues = false {
        didSet {
            setNeedsDisplay()
        }
    }
